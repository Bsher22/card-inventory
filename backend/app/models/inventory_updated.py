...
class Inventory(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "(item_type = 'card' AND checklist_id IS NOT NULL AND standalone_item_id IS NULL) OR "
            "(item_type != 'card' AND checklist_id IS NULL AND standalone_item_id IS NOT NULL)",
            name='chk_inventory_item_reference'
        ),
    )
