...
@router.get("/auth/companies", response_model=list[GradingCompanyWithLevels])
...
@router.get("/auth/companies/{company_id}/service-levels", response_model=list[ServiceLevelResponse])
...
@router.get("/auth/submissions", response_model=list[AuthSubmissionResponse])
...
@router.get("/auth/submissions/stats", response_model=AuthStats)
...
@router.get("/auth/submissions/pending-by-company", response_model=list[AuthPendingByCompany])
...
@router.get("/auth/submissions/{submission_id}", response_model=AuthSubmissionResponse)
...
@router.post("/auth/submissions", response_model=AuthSubmissionResponse, status_code=201)
...
@router.patch("/auth/submissions/{submission_id}/status", response_model=AuthSubmissionResponse)
...
@router.post("/auth/submissions/{submission_id}/results", response_model=AuthSubmissionResponse)
...
@router.delete("/auth/submissions/{submission_id}", status_code=204)
...
@router.get("/auth/items/cards", response_model=list[AuthItemResponse])
...
@router.get("/auth/items/memorabilia", response_model=list[AuthItemResponse])
...
@router.get("/auth/items/collectibles", response_model=list[AuthItemResponse])
